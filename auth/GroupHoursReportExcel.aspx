<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupHoursReportExcel.aspx.cs" Inherits="MSI.Web.MSINet.GroupHoursReportExcel" EnableViewState="false" %>

<%@ Register Src="../Controls/MSINetGroupHoursReport.ascx" TagName="MSINetGroupHoursReport"
    TagPrefix="uc6" %>
...
<body >  <div align="center">
    ...
    <form id="Form1" runat="server" enableviewstate="false">
            <uc6:MSINetGroupHoursReport id="ctlHoursReport" runat="server" ExportToExcel="true" EnableViewState="false">
            </uc6:MSINetGroupHoursReport> 
    </form>
        </asp:Panel>
 </div>    
</body>
