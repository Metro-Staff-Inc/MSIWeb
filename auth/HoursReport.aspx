<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HoursReport.aspx.cs" Inherits="MSI.Web.MSINet.HoursReport" %>
<%@ Register Src="~/Controls/MSINetHoursReport.ascx" TagName="MSINetHoursReport" TagPrefix="uc6" %>
...
<body>  <div align="center">
    ...
    <div>
        ...
        <uc4:MSINetSectionHeader ID="ctlSectionHeader" runat="server" SectionHeader="Hours Report" />
        ...
        <asp:Panel ID="pnlHoursReport" runat="server" HorizontalAlign="Left" Width="1100px">
            <div style="text-align:right"><asp:HyperLink Visible="false" ID="lnkPrinterFriendly" Target="_blank" NavigateURL="~/auth/HoursReport.aspx?print=1" runat="server" Text="Printer Friendly Version"></asp:HyperLink></div>
            <uc6:MSINetHoursReport id="ctlHoursReport" runat="server"></uc6:MSINetHoursReport>
        </asp:Panel>
    </form>
 </div>    
</body>
