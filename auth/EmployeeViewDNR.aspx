<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeViewDNR.aspx.cs" Inherits="auth_EmployeeViewDNR" %>
...
<div align="center">
    ...
    <div visible="false">
        ...
        <input type="hidden" runat="server" id="hdnSetDnr" value="true" />
    </div>
    ...
    <div>
        ...
        <uc4:MSINetSectionHeader ID="ctlSectionHeader" runat="server" SectionHeader="View Employee DNR Info" />
