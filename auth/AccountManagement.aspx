<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountManagement.aspx.cs" Inherits="MSI.Web.MSINet.AccountManagement" %>
...
<body>  <div align="center">
    ...
    <%--    &nbsp;&nbsp;<uc2:MSINetSubHeader ID="ctlSubHeader" runat="server" /> --%>
        <br />
        <%-- <uc3:MSINetMainMenu ID="ctlMainMenu" runat="server" SelectedSection="MainMenu" /> --%>
        <uc4:MSINetSectionHeader ID="ctlSectionHead" runat="server" SectionHeader="Change Your Password" />
        <asp:Panel ID="pnlMain" runat="server" Height="373px" HorizontalAlign="Center" Width="999px">
            <asp:ChangePassword ID="ctlChangePassword" CssClass="PasswordChange" runat="server" 
            ContinueDestinationPageUrl = "~/auth/MainMenu.aspx" CancelDestinationPageUrl="~/anon/Login.aspx"
            ChangePasswordTitleText="Change Password" PasswordLabelText="Current Password:">
            </asp:ChangePassword>
            &nbsp;</asp:Panel>
    </form>
 </div>    
