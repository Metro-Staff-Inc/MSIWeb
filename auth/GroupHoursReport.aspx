<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupHoursReport.aspx.cs" Inherits="MSI.Web.MSINet.GroupHoursReport" %>
<%@ Register Src="~/Controls/MSINetGroupHoursReport.ascx" TagName="MSINetGroupHoursReport" TagPrefix="uc6" %>
...
<body>  <div align="center">
    ...
    <div>
        ...
        <br />
        <uc3:MSINetMainMenu ID="MainMenu2" runat="server" SelectedSection="HoursReport" />

        <uc4:MSINetSectionHeader ID="ctlSectionHeader" runat="server" SectionHeader="Group Hours Report" />
        ...
        <asp:Panel ID="pnlHoursReport" runat="server" HorizontalAlign="Left" Width="1100px">
            <div style="text-align:right"><asp:HyperLink ID="lnkPrinterFriendly" Target="_blank" NavigateURL="~/auth/HoursReport.aspx?print=1" runat="server" Text="Printer Friendly Version"></asp:HyperLink></div>
            <uc6:MSINetGroupHoursReport id="ctlHoursReport" runat="server"></uc6:MSINetGroupHoursReport>
        </asp:Panel>
    </form>
 </div>    
</body>
