<%@ Page Language="C#" EnableEventValidation="false" EnableViewState="false" EnableViewStateMac="false" AutoEventWireup="true" CodeFile="UserRoles.aspx.cs" Inherits="MSI.Web.MSINet.UserRoles" %>
...
<body><div align="center">
    ...
    <uc1:MastHead ID="MastHead1" runat="server" />
        ...
        <br />
        <uc3:MSINetMainMenu ID="ctlMainMenu" runat="server" SelectedSection="UserRoles" />
                
        <uc4:MSINetSectionHeader ID="ctlSectionHead" runat="server" SectionHeader="Create User / Set User Roles" />
        <br />

        <uc5:MSINetUserRoles id="ctlUserRoles" runat="server" DisplayMode="Swipe">
        </uc5:MSINetUserRoles>
