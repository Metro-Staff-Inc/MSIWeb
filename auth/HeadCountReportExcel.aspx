<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HeadCountReportExcel.aspx.cs" Inherits="MSI.Web.MSINet.HeadCountReportExcel" EnableViewState="false" %>
  ...
  -->
    ...
    <xml> 
         <x:ExcelWorkbook> 
          <x:ExcelWorksheets> 
           <x:ExcelWorksheet> 
                <x:Name>Head Count Report</x:Name> 
                <x:WorksheetOptions> 
                 <x:FitToPage/> 
                 <x:Print> 
         ...
         <x:ExcelName> 
          ...
          <x:Formula>='Head Count Report'!$1:$5</x:Formula>
         </x:ExcelName> 
</xml>
...
<body>  <div align="center">
        <asp:Panel ID="Panel1" runat="server" Height="159px" HorizontalAlign="Left" Width="990px" EnableViewState="false">
            <uc6:MSINetHeadCountReport id="ctlHeadCountReport" runat="server" ExportToExcel="true" EnableViewState="false">
