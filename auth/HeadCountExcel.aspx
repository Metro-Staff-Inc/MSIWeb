<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HeadCountExcel.aspx.cs" Inherits="MSI.Web.MSINet.HeadCountExcel" EnableViewState="false" %>

<%@ Register Src="../Controls/MSINetHeadCountExcel.ascx" TagName="MSINetHeadCountExcel"
    TagPrefix="uc6" %> 
...
<head visible="false" id="Head1" runat="server">
...
<body >  <div align="center">
    ...
    <form id="Form1" runat="server" enableviewstate="false">
            <uc6:MSINetHeadCountExcel id="ctlHeadCountExcel" runat="server" ExportToExcel="true" EnableViewState="false">
            </uc6:MSINetHeadCountExcel>
    </form>
        </asp:Panel>
 </div>    
</body>
