<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HeadCount.aspx.cs" Inherits="MSI.Web.MSINet.HeadCount" %>

<%@ Register Src="../Controls/MSINetHeadCount.ascx" TagName="MSINetHeadCount"
    TagPrefix="uc6" %>
...
<body>  <div align="center">
    ...
    <div>
        ...
        <asp:Panel ID="pnlHeadCountReport" runat="server" HorizontalAlign="Left" Width="905px">
            ...
            <uc6:MSINetHeadCount id="ctlHeadCount" runat="server">
            </uc6:MSINetHeadCount>
        </asp:Panel>
