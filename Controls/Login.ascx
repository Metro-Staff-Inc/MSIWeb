...
<div style=" width:240px; background-color:#CCCCFF; border:4px double blue; padding:4px 4px 4px 4px">
<asp:Panel ID="Panel2" runat="server" Width="230px"  CssClass="MSINetLoginIDPanel" HorizontalAlign="Left" BorderColor="White">
    ...
    <br />
    <asp:TextBox ID="txtUserID" runat="server" CssClass="MSINetBodyText" Width="175px"></asp:TextBox><br />
    ...
    <div style="padding:4px 1px 1px 1px;">
    <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left" Width="230px">
        <asp:Button ID="btnLogIn" runat="server" Text="Log In" OnClick="btnLogIn_Click" /><asp:Label ID="lblValidationMessage" runat="server"  CssClass="MSINetValidationText"
            Text="Label" Visible="False" Width="230px"></asp:Label></asp:Panel>
    </div>
</div>